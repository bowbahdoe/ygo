...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        yugioh_h.C_POINTER.withName("__routine"),
        yugioh_h.C_POINTER.withName("__arg"),
        yugioh_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = yugioh_h.upcallHandle(__routine.Function.class, "apply", $DESC);
